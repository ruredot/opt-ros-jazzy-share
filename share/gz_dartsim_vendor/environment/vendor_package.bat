...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\gz_dartsim_vendor\bin"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\gz_dartsim_vendor\lib"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\gz_dartsim_vendor\lib64"
