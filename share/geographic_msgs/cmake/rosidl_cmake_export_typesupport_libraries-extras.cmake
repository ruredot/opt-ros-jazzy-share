...
set(_exported_typesupport_libraries
  "__rosidl_typesupport_fastrtps_c:geographic_msgs__rosidl_typesupport_fastrtps_c;__rosidl_typesupport_fastrtps_cpp:geographic_msgs__rosidl_typesupport_fastrtps_cpp")
  ...
  foreach(_tuple ${_exported_typesupport_libraries})
    ...
    if(NOT IS_ABSOLUTE "${_library}")
      ...
      if(NOT _lib)
        ...
        message(FATAL_ERROR
          "Package 'geographic_msgs' exports the typesupport library '${_library}' which couldn't be found")
      elseif(NOT IS_ABSOLUTE "${_lib}")
        # the found library must be an absolute path
        message(FATAL_ERROR
          "Package 'geographic_msgs' found the typesupport library '${_library}' at '${_lib}' "
