...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\sdformat_vendor\bin"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\sdformat_vendor\lib"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\sdformat_vendor\lib64"
